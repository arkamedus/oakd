...
export const SmallText: Story = {
    render: () => <Paragraph><small>This is small text.</small></Paragraph>,
};

export const StrongText: Story = {
    render: () => <Paragraph><strong>This is strong text.</strong></Paragraph>,
};

export const EmphasizedText: Story = {
    render: () => <Paragraph><em>This is emphasized text.</em></Paragraph>,
};
