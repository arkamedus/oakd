...
function computeLineFromSelection(value: string, selectionStart: number): number {
...
const CodeArea = forwardRef<HTMLTextAreaElement, CodeAreaProps>(
  (
    ...
    const lineRows = Array.from({ length: lineCount }, (_, i) => {
      ...
      const isCur = highlightCurrentLine && ln === currentLine;
      ...
      <div data-testid="CodeArea" className={containerClasses} style={style}>
        <div className="codearea-editor">
          ...
          <textarea
            ...
            onFocus={(e) => {
              onFocus?.(e);
              updateCurrentLine(effectiveValue);
              requestAnimationFrame(syncScroll);
            }}
            onScroll={syncScroll}
